...
class Validator: 
    ...
    def validate_user_login_credentials(self, user_name, user_password):
        ...
        if user_name != "Admin" and user_password != "Admin123":
            return jsonify({'error': "Invalid username and password, try again"})
        # else:
    ...
    def validate_user_credentials(self, name, gender, dateofbirth, maritalstatus,
